...
|------|-----|-----------------------------------|
| `index.html` | Convert: what is this → tiers → proof → October 3 signup | Proof stats ← `v_step_totals` + `v_city_claims_all`; form → Turnstile-verified `website-signup` Edge endpoint; dropdowns ← `cities` |
