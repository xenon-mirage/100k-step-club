...
test('landing metadata, schema, hero, and countdown share the locked event date', function () {
  ...
  assert.match(index, /class="event-mo">October<\/span>/, 'the split, large visual month must match the event');
...
test('active event surfaces contain no stale June or September date or unsupported event number', function () {
  [
    'index.html',
    'tiers.html',
    'sun.html',
